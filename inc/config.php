...
$config['database']['database'] = 'hendrasolution_n';
$config['database']['table_prefix'] = 'mybb_';

$config['database']['hostname'] = 'mysql0.db.koding.com';
$config['database']['username'] = 'hendrasolution_n';
$config['database']['password'] = 'tZHz3OIhrI8Kp3xB5auihGDwHV2ZhC30FjACGgKj';
